...
import { EVMSpokePoolClient, SpokePoolClient, SvmSpokePoolClient, mocks } from "../src/clients";
...
describe("SpokePoolClient: Deposit Routes", function () {
  ...
  describe("SVM", function () {
    let eventClient: mocks.MockSolanaEventClient;
    let spokePoolClient: SpokePoolClient;

    beforeEach(async function () {
      eventClient = new mocks.MockSolanaEventClient();
