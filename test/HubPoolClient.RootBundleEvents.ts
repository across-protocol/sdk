...
describe("HubPoolClient: RootBundle Events", function () {
  ...
  describe("HubPoolClient: UBA-specific runningBalances tests", function () {
    ...
    it("extracts running incentive balances", async function () {
      for (let version = constants.CONFIG_STORE_VERSION; version < maxConfigStoreVersion; ++version) {
        if (version != constants.CONFIG_STORE_VERSION) {
        ...
        const leafEvents = chainIds.map((chainId, idx) => {
          ...
          const runningBalances =
            version < constants.CONFIG_STORE_VERSION
        ...
        executedLeaves.forEach((executedLeaf, idx) => {
          ...
          const expectedRunningBalances: BigNumber[] =
            version < constants.CONFIG_STORE_VERSION
