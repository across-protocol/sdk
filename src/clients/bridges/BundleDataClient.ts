...
import { getImpliedBundleBlockRanges, getEndBlockBuffers, getBlockRangeForChain } from "../../utils";
import { getWidestPossibleExpectedBlockRange } from "../../utils/PoolRebalanceUtils";
...
export class BundleDataClient {
  ...
  constructor(
    ...
    readonly clients: { hubPoolClient: HubPoolClient; configStoreClient: AcrossConfigStoreClient },
  ...
  async getNextBundleRefunds(): Promise<FillsToRefund> {
    const futureBundleEvaluationBlockRanges = getWidestPossibleExpectedBlockRange(
      ...
      this.clients,
      this.clients.hubPoolClient.latestBlockNumber ?? 0,
