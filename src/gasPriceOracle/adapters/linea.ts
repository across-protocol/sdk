...
export function eip1559(provider: providers.Provider, chainId: number, markup: number): Promise<GasPriceEstimate> {
  return ethereum.legacy(provider, chainId, markup);
}
