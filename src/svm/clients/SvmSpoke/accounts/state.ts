...
export function getStateEncoder(): Encoder<StateArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['pausedDeposits', getBooleanEncoder()],
      ['pausedFills', getBooleanEncoder()],
      ['owner', getAddressEncoder()],
      ['seed', getU64Encoder()],
      ['numberOfDeposits', getU32Encoder()],
      ['chainId', getU64Encoder()],
      ['currentTime', getU32Encoder()],
...
export function getStateDecoder(): Decoder<State> {
  return getStructDecoder([
    ...
    ['pausedDeposits', getBooleanDecoder()],
    ['pausedFills', getBooleanDecoder()],
    ['owner', getAddressDecoder()],
    ['seed', getU64Decoder()],
    ['numberOfDeposits', getU32Decoder()],
    ['chainId', getU64Decoder()],
    ['currentTime', getU32Decoder()],
