...
export const DEPOSIT_NOW_DISCRIMINATOR = new Uint8Array([
  75, 228, 135, 221, 200, 25, 148, 26,
]);

export function getDepositNowDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(DEPOSIT_NOW_DISCRIMINATOR);
}

export type DepositNowInstruction<
...
export function getDepositNowInstructionDataEncoder(): Encoder<DepositNowInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['fillDeadlineOffset', getU32Encoder()],
      ['exclusivityParameter', getU32Encoder()],
      ['message', addEncoderSizePrefix(getBytesEncoder(), getU32Encoder())],
    ]),
    (value) => ({ ...value, discriminator: DEPOSIT_NOW_DISCRIMINATOR })
  );
}

export function getDepositNowInstructionDataDecoder(): Decoder<DepositNowInstructionData> {
  return getStructDecoder([
    ...
    ['fillDeadlineOffset', getU32Decoder()],
    ['exclusivityParameter', getU32Decoder()],
    ['message', addDecoderSizePrefix(getBytesDecoder(), getU32Decoder())],
  ]);
}

export function getDepositNowInstructionDataCodec(): Codec<
  DepositNowInstructionDataArgs,
  DepositNowInstructionData
> {
  return combineCodec(
    getDepositNowInstructionDataEncoder(),
    getDepositNowInstructionDataDecoder()
  );
}

export type DepositNowAsyncInput<
...
export async function getDepositNowInstructionAsync<
  TAccountSigner extends string,
  TAccountState extends string,
  TAccountDelegate extends string,
  TAccountDepositorTokenAccount extends string,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getDepositNowInstructionDataEncoder().encode(
      args as DepositNowInstructionDataArgs
    ),
...
export function getDepositNowInstruction<
  TAccountSigner extends string,
  TAccountState extends string,
  TAccountDelegate extends string,
  TAccountDepositorTokenAccount extends string,
...
export type ParsedDepositNowInstruction<
  TProgram extends string = typeof SVM_SPOKE_PROGRAM_ADDRESS,
...
export function parseDepositNowInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedDepositNowInstruction<TProgram, TAccountMetas> {
