...
export const DEPOSIT_FOR_BURN_WITH_HOOK_DISCRIMINATOR = new Uint8Array([
  111, 245, 62, 131, 204, 108, 223, 155,
]);

export function getDepositForBurnWithHookDiscriminatorBytes() {
...
export type DepositForBurnWithHookInstructionData = {
...
export function getDepositForBurnWithHookInstructionDataEncoder(): Encoder<DepositForBurnWithHookInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: DEPOSIT_FOR_BURN_WITH_HOOK_DISCRIMINATOR,
    })
  );
}

export function getDepositForBurnWithHookInstructionDataDecoder(): Decoder<DepositForBurnWithHookInstructionData> {
...
export function getDepositForBurnWithHookInstructionDataCodec(): Codec<
  DepositForBurnWithHookInstructionDataArgs,
  DepositForBurnWithHookInstructionData
> {
  return combineCodec(
    getDepositForBurnWithHookInstructionDataEncoder(),
    getDepositForBurnWithHookInstructionDataDecoder()
  );
}

export type DepositForBurnWithHookAsyncInput<
...
> = {
  ...
  amount: DepositForBurnWithHookInstructionDataArgs['amount'];
  destinationDomain: DepositForBurnWithHookInstructionDataArgs['destinationDomain'];
  mintRecipient: DepositForBurnWithHookInstructionDataArgs['mintRecipient'];
  destinationCaller: DepositForBurnWithHookInstructionDataArgs['destinationCaller'];
  maxFee: DepositForBurnWithHookInstructionDataArgs['maxFee'];
  minFinalityThreshold: DepositForBurnWithHookInstructionDataArgs['minFinalityThreshold'];
  hookData: DepositForBurnWithHookInstructionDataArgs['hookData'];
};

export async function getDepositForBurnWithHookInstructionAsync<
  TAccountOwner extends string,
  TAccountEventRentPayer extends string,
  TAccountSenderAuthorityPda extends string,
  TAccountBurnTokenAccount extends string,
...
>(
  input: DepositForBurnWithHookAsyncInput<
    TAccountOwner,
    TAccountEventRentPayer,
    TAccountSenderAuthorityPda,
    TAccountBurnTokenAccount,
  ...
  DepositForBurnWithHookInstruction<
    TProgramAddress,
    TAccountOwner,
    TAccountEventRentPayer,
    TAccountSenderAuthorityPda,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getDepositForBurnWithHookInstructionDataEncoder().encode(
      args as DepositForBurnWithHookInstructionDataArgs
    ),
  } as DepositForBurnWithHookInstruction<
    TProgramAddress,
    TAccountOwner,
    TAccountEventRentPayer,
    TAccountSenderAuthorityPda,
...
export type DepositForBurnWithHookInput<
  TAccountOwner extends string = string,
  TAccountEventRentPayer extends string = string,
  TAccountSenderAuthorityPda extends string = string,
  TAccountBurnTokenAccount extends string = string,
...
export function getDepositForBurnWithHookInstruction<
  ...
  TProgramAddress extends Address =
    typeof TOKEN_MESSENGER_MINTER_V2_PROGRAM_ADDRESS,
>(
  input: DepositForBurnWithHookInput<
    TAccountOwner,
    TAccountEventRentPayer,
    TAccountSenderAuthorityPda,
    TAccountBurnTokenAccount,
...
export type ParsedDepositForBurnWithHookInstruction<
  TProgram extends string = typeof TOKEN_MESSENGER_MINTER_V2_PROGRAM_ADDRESS,
...
> = {
  ...
  data: DepositForBurnWithHookInstructionData;
};

export function parseDepositForBurnWithHookInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedDepositForBurnWithHookInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getDepositForBurnWithHookInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
